...
برای فعال‌سازی کامل، به عنوان ادمین وارد ربات خود شوید و مراحل زیر را دنبال کنید:
...
برای به‌روزرسانی ربات به آخرین نسخه منتشر شده، 
نیازی به کار پیچیده‌ای نیست. 
کافیست دقیقاً همان دستور نصب یک خطی بالا را دوباره روی سرور خود اجرا کنید.
اسکریپت هوشمندانه عمل کرده و آخرین نسخه را از گیت‌هاب دریافت و جایگزین نسخه فعلی می‌کند، 
بدون اینکه اطلاعات یا تنظیمات شما از بین برود.
گردش کار آپدیت:
