# FILE: modules/financials/actions/settings.py (REVISED FOR I18N and BEST PRACTICES)
...
# =============================================================================
# 2. Card-to-Card Settings Conversation
# =============================================================================
...
async def format_financial_info_message() -> str:
    ...
    card_holder = financials.get('card_holder', not_set_str)
    card_number = financials.get('card_number', not_set_str)
...
# =============================================================================
# 3. Plan Name Settings Conversation
# =============================================================================
